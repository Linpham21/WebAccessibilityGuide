...
let introTextSection = [
    {
        mainIdea: 'Less than 5% of the world\'s top million websites are designed to be disability inclusive',
        paragraph: 'insert'
    },
    {
...
let articles = {
    'General Introduction': {
        ...
        photo: 'imgs/web-accessibility.png',
        photo_alt: 'Web Accessibility Art',
